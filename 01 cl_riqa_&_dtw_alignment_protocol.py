# -*- coding: utf-8 -*-
"""CL-RIQA & DTW Alignment Protocol.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wEDYMVEWpYCys_rdUa2ag5pCnfn66R95
"""
...
try:
    ...
    print("Installing required package: fastdtw...")
...
def main():
    ...
    # 1. Image Upload
    print("\n[Step 1] Upload CL Image (JPG/PNG)...")
    ...
    # 2. Data Upload
    print("\n[Step 2] Upload LA-ICP-MS Data (.csv)...")
    csv_upload = files.upload()
    if not csv_upload:
        print("Error: No CSV uploaded.")
        return
